 ...
 */
public class SignUpProfileContractFragment extends Fragment {

    private EditText contract;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_sign_up_profile_contract, container, false);
